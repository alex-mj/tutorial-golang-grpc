...
type MathServiceClient interface {
	MathFunc(ctx context.Context, in *MathObject, opts ...grpc.CallOption) (*MathResponse, error)
}
...
func (c *mathServiceClient) MathFunc(ctx context.Context, in *MathObject, opts ...grpc.CallOption) (*MathResponse, error) {
	out := new(MathResponse)
	err := c.cc.Invoke(ctx, "/math.MathService/MathFunc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMathServiceServer) MathFunc(context.Context, *MathObject) (*MathResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MathFunc not implemented")
}
...
func _MathService_MathFunc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MathObject)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MathServiceServer).MathFunc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/math.MathService/MathFunc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MathServiceServer).MathFunc(ctx, req.(*MathObject))
	}
...
var MathService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "MathFunc",
			Handler:    _MathService_MathFunc_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "mathfunc.proto",
}
